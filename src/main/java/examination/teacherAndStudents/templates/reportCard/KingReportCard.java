...
@Component("KingReportCard")
public class KingReportCard implements ReportCard {
    @Override
    public String generateReport(ResultSummary resultSummary) {
        StringBuilder report = new StringBuilder();
        report.append("===========================================================\n");
        report.append("                       KING ACADEMY\n");
        report.append("                   Building Future Leaders\n");
        report.append("===========================================================\n");
        report.append("Student ID: ").append(resultSummary.getStudentId()).append("\tClass Level: ").append(resultSummary.getClassLevelId()).append("\n");
        report.append("Session: ").append(resultSummary.getSessionId()).append("\tTerm: ").append(resultSummary.getTerm()).append("\n\n");
